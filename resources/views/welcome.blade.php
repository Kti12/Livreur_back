...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="{{asset('dashboard/Images/logo_aisa')}}" href="#">
...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			<!-- Coming Soon -->
			<div class="bg-img-fix overflow-hidden" style="background:#fff url(Images/bg6.jpg); height: 100vh;">
				<div class="row gx-0">
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="#" class="logo"><img src="Images/logo_aisa.png" alt="" class="aisa"></a>
											    ...
											    <form action="/index" class=" dz-form pb-3" method="GET">
													...
													<div class="form-group text-left mb-5 forget-main">
														...
														<span class="form-check d-inline-block">
															...
															<label class="form-check-label" for="check1">Se rappeller de moi</label>
														</span>
													...
													<div class="social ">
                                                        <div class="h5-social">
														    <h5 class="btn-connecter">Se connecter avec</h5>
                                                        </div>
                                                        <div class="ul-social">
														    <ul class="dz-social-icon dz-border dz-social-icon-lg text-white">
														    	<li><a target="_blank" href="https://www.facebook.com/" ><img src="Images/facebook.png" alt="" class="facebook"></a></li>
														    	<li><a target="_blank" href="https://www.google.com/" ><img src="Images/google.png" alt="" class="google"></a></li>
										...
										<div class="card-footer">
											...
											<div class="col-lg-12 text-center">
												...
												<a href="#">AISA </a> Tout droits réservés.</span> 
											</div>
										</div>
									</div>	
